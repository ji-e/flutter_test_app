class StringUtils {
  ...
  static String signin_network_msg = '네트워크에 연결되어있지 않습니다.\n네트워크를 확인해주세요.';

  static String signin_title = '로그인';
  static String signin_email = '이메일';
  static String signin_email_hint = '이메일을 입력해주세요.';
